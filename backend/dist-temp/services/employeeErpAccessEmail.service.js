...
exports.EMPLOYEE_ERP_ACCESS_TEMPLATE = void 0;
exports.buildEmployeeErpAccessEmailHtml = buildEmployeeErpAccessEmailHtml;
exports.sendEmployeeErpAccessEmail = sendEmployeeErpAccessEmail;
const database_1 = __importDefault(require("../config/database"));
const email_service_1 = require("./email.service");
exports.EMPLOYEE_ERP_ACCESS_TEMPLATE = 'employee_erp_login_details_v1';
function esc(s) {
    return String(s ?? '')
        .replace(/&/g, '&amp;')
        .replace(/</g, '&lt;')
...
function buildEmployeeErpAccessEmailHtml(vars) {
...
async function sendEmployeeErpAccessEmail(params) {
    ...
    try {
        await (0, email_service_1.sendEmail)(params.toEmail, subject, html);
        await database_1.default.emailLog.create({
            data: {
                recipientEmail: params.toEmail,
                subject,
                template: exports.EMPLOYEE_ERP_ACCESS_TEMPLATE,
                status: 'SENT',
...
//# sourceMappingURL=employeeErpAccessEmail.service.js.map