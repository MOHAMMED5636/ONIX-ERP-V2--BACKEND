...
import projectDeletionRequestsRoutes from './routes/projectDeletionRequests.routes';
...
import roleAbilitiesRoutes from './routes/roleAbilities.routes';
...
import documentExpiryRoutes from './routes/documentExpiry.routes';
import projectManagerTransferRoutes from './routes/projectManagerTransfer.routes';
...
app.use('/api/project-deletion-requests', projectDeletionRequestsRoutes);
...
app.get('/api/public/leave-certificates/:id/meta', leaveWorkflowController.publicLeaveCertificateMeta);
app.get('/api/public/leave-certificates/:id', leaveWorkflowController.publicVerifyLeaveCertificate);
...
app.use('/api/role-abilities', roleAbilitiesRoutes);
app.use('/api/push', pushNotificationsRoutes);
app.use('/api/document-expiry', documentExpiryRoutes);
app.use('/api/project-manager-transfers', projectManagerTransferRoutes);
